...
Camera::Camera(const size_t &image_width, const size_t &image_height,
               const double &fov_width, const double &fov_height,
               const double &focal_length, const double &defocus_angle,
               const Point3D &position, const Eigen::Quaterniond &rotation,
